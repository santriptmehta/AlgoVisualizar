...
class BubbleSortActivity : ComponentActivity() {
    private val viewModel : BubbleViewModel by lazy {
        val viewModelProviderFactory = BubbleViewModelProvider(BubbleSort())
        ViewModelProvider(this, viewModelProviderFactory)[BubbleViewModel::class.java]
    }
